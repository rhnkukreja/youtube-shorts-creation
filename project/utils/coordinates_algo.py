...
def get_text_placement(text, number_i,image_width=1080, image_height=1920, font_path = PROJECT_PATH+"\utils\Bookman Old Style Bold Italic.ttf" , font_size=FONT_SIZE):
