...
if __name__=="__main__":
    image_description="Shimla in winters with snow"
    file_path=fr"C:\Users\Rohan\Desktop\rohan_projects\youtube_shorts\backend\images\{image_description}.png"
    GetImages().get_image_path(file_path, image_description)
